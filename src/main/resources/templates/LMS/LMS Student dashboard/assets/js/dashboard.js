  ...
  $(function() {
    ...
    if ($("#visit-sale-chart-dark").length) {
      ...
      var myChart = new Chart(ctx, {
        type: 'line',
        data: {
            labels: ['Q1-QA', 'Q2-Java', 'Q3-C Prog.', 'Q4-Python', 'Q5-HTML/CSS', 'Q6-PHP', 'Q7-Testing', 'Q8-Django'],
            datasets: [
              {
                label: "Percentages",
                borderColor: gradientStrokeViolet,
                ...
                data: [5 ,20, 100, 15, 35, 25, 50, 30, 20]
              }
              // {
              //   label: "USA",
              //   borderColor: gradientStrokeRed,
    ...
    if ($("#traffic-chart").length) {
      ...
      gradientStrokeBlue.addColorStop(0, 'rgba(218, 201, 230, 1)');
      gradientStrokeBlue.addColorStop(1, 'rgba(218, 201, 230, 1)');
      var gradientLegendBlue = 'linear-gradient(to right, rgba(218, 201, 230, 1), rgba(218, 201, 230, 1))';

      var gradientStrokeRed = ctx.createLinearGradient(0, 0, 0, 50);
      gradientStrokeRed.addColorStop(0, 'rgba(141, 231, 171, 1)');
      gradientStrokeRed.addColorStop(1, 'rgba(141, 231, 171, 1)');
      ...
      gradientStrokeGreen.addColorStop(0, 'rgba(171, 179, 173, 0.806)');
      gradientStrokeGreen.addColorStop(1, 'rgba(171, 179, 173, 0.806)');
